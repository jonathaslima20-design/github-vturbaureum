    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        >
          ...
          >
            {/* Cover Image - matches CorretorPage rounded style */}
            ...
            {/* Name & Bio */}
            <div className="text-center px-4 mt-2" style={{ marginBottom: '12px' }}>
              <h1
            ...
            {/* Social Buttons - circular outline style matching CorretorPage */}
            ...
            {/* Search Bar - matches CorretorPage with separate Filtros button */}
            <div className="px-3 mb-3">
...
function ProductMockupCard({
  ...
  return (
    ...
    >
      {/* Image - padded container matching real ProductCard */}
      <div className="p-1.5">
        <div
      ...
      {/* Info */}
      <div className="px-1.5 pb-1.5 flex-1 flex flex-col">
        <p
